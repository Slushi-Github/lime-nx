...
class NativeAudioSource
{
	...
	*/
	...
	{
		return parent.buffer != null && (parent.buffer.__srcVorbisBytes != null || parent.buffer.__srcVorbisPath != null || parent.buffer.__srcVorbisFile != null);
	}
	...
	*/
	...
	private function streamThreadFunc():Void
	{
		...
		while (decodeThreadRunning)
		{
			...
			{
				// Keep thread alive even if an AL call fails
			}
		}
	}
